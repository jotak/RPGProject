...
// Name : init
// -----------------------------------------------------------------
void guiButton::init(string sText, FontId fontId, Color textColor, Texture * pClickedTex, BtnClickOptions clickOption, Texture * pOverTex, BtnClickOptions overOption, Texture * pTex, string sCpntId, int xPxl, int yPxl, int wPxl, int hPxl)
{
    guiImage::init(pTex, sCpntId, xPxl, yPxl, wPxl, hPxl);
    m_pLabel->init(sText, fontId, textColor, "ButtonLabel", 0, 0, 0, 0);
...
// -----------------------------------------------------------------
void guiButton::setNormalTexture(Texture * pTex)
{
...
// Name : attachImage
// -----------------------------------------------------------------
void guiButton::attachImage(Texture * pTex)
{
    if (m_pGeometryAttachedImage == NULL)
    {
        ...
        m_pGeometryAttachedImage->setTexture(pTex);
    }
}
