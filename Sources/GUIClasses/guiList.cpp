...
// Name : init
// -----------------------------------------------------------------
void guiList::init(FontId fontId, Color textColor, Texture ** pMainTexs, string sCpntId, int xPxl, int yPxl, int wPxl, int hPxl)
{
...
guiObject * guiList::clone()
{
    ...
    guiList * pObj = new guiList();
    pObj->init(m_FontId, m_TextColor, texlist, m_sCpntId, m_iXPxl, m_iYPxl, m_iWidth, m_iHeight);
    return pObj;
}
